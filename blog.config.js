...
const BLOG = {
  AUTHOR: 'GCD', // 作者
  BIO: '对世界充满热爱的冷漠的人', // 作者简介
  LINK: 'https://notion-next-dusky-eight.vercel.app/', // 网站地址
  KEYWORDS: 'GCD, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'gcd168@foxmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个非盈利的站点', // 站点描述，被notion中的页面描述覆盖
